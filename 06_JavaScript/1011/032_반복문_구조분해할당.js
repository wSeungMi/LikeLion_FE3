...
for (i of value2){ // of로 순회를 돌아야 key와 value를 한꺼번에 출력하고 싶음. -> error
    console.log(i)
}
...
for (i of Object.entries(value2)){ 
    console.log(`key는 ${i[0]}고 value는 ${i[j]}입니다.`)
}
...
for ([i, j] of [[10, 20, 300], [30, 40, 500]]){ 
    console.log(i, j) // 300과 500을 받지 못했음.
}
...
// [one1, two1, three1, ...four1] = '010-1234-5678-01-02-03'.split('-')
