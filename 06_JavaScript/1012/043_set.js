...
let s = new Set('abcdeeeeeee') // 중복제거
console.log(s);
console.log(s.size);

// 문제
회사게시판 = ['우승미', '우승미', '우승미', '김멋사', '김멋사', '이멋사']

// 문제 1 : 몇 명이 게시판에 게시물을 썼나요?
let count = new Set(회사게시판)
console.log(count.size) // 3명

// 문제 2: 각각 몇 개의 게시물을 작성하였나요?
// 사람마다 게시물 몇개를 썼는지 카운팅 -> 순회가 가능한가?
for (const i of set) {
